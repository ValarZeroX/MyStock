...
@Database(entities = [UserSettings::class, StockAccount::class, StockRecord::class, StockSymbol::class, StockMarket::class, Currency::class], version = 1, exportSchema = false)
